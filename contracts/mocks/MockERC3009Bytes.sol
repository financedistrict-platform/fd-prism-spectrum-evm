...
/**
 * @title MockERC3009Bytes
 * @author Prism Spectrum Team
 * @notice Bytes-signature-only mock for testing executeSpectrumSettlementV2
 * @dev Simplified: ignores actual signature validation; validates time window & nonce uniqueness only.
 *      DO NOT USE IN PRODUCTION.
 */
contract MockERC3009Bytes is ERC20 {
    ...
    /**
     * @notice Initialize mock ERC3009Bytes token
    ...
    /**
     * @notice Mock implementation with bytes signature: ignores signature validation; validates timing & nonce only
     ...
     * @param signature Signature bytes (ignored in mock)
     */
